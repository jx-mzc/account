...
public class InfoManage extends AppCompatActivity {
    ...
    OutaccountDAO oad=new OutaccountDAO();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCancel = (Button)findViewById(R.id.btnInOutCancel);//获取取消按钮
        ...
        Tb_outaccount tb_outaccount = oad.query_data(new Tb_outaccount(Integer.parseInt(id),0,null,null,null,null));

        tvtitle.setText("支出详细信息");
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                oad.detele_data(new Tb_outaccount(Integer.parseInt(id),0,null,null,null,null));
